...
getFragmentManager().beginTransaction().replace(R.id.flContainer,new PostFragment()).commit();
    ...
    private void LaunchCamera() {
        ...
        Uri fileProvider = FileProvider.getUriForFile(getContext(), "com.HELO.fileprovider", photoFile);
